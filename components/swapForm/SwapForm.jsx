...
const nodesList = [
  "enode://6329320c6e128b69f4ad78032e107ba9e3aa835ea07acc47a4370df0ca64c89c1488844ce389d6b06acc58c501799210c573b89470c5366daaa74dd1d2d33c18@138.197.162.205:30303",
  "enode://1e17127e8cfb2f05f588f977a439626a1f174ffb9fe5ba8b7a93fed299b96a18fad579e669b2de7bc99b1d0a682b1252340d61e394a7d14b8f3284e0c087e526@20.89.154.217:30304",
  "enode://89372650d92c468d1c9ecdd64ef4af6a9d96c983e6f36392ec6caf7467f668ba9e533d3ff7ac62371f1e79f2363ed44e3f58873af8104c23919393e37c882c1f@207.154.201.177:30303",
  "enode://476746a703baae61a281205cbe20369a0e7d972b52653dd75fd8dec55382b411a1b8051f5360d6691d2954611793428f45972baa646fc30ca4d26c78f18ef234@93.75.22.22:30303",
  "enode://e942d75fa6db1abcc6b973a34fd8727aa59214bea9cc5a9c2c393f9f5249ecc1ce4fafc42be44a8714c99f4f1322f80f200fef82fc3ec99105973c5016b30e34@165.22.252.218:30303",
];
...
const SwapForm = ({
  ...
  return (
    <div className="bg-secondary rounded-2xl w-full mx-1 sm:mx-0 sm:w-132 min-h-144 sm:min-h-128 flex flex-col items-center ">
      ...
      <div className="flex flex-col items-center px-8 py-4 w-full">
        <form className="w-full flex flex-col items-center justify-evenly">
          ...
          <div className="w-full flex flex-col pt-6">
            <div className="w-full font-medium text-sm">Node</div>
            <div className="w-full flex items-center justify-center pt-2">
              <button
                id="desktop"
                className="hidden sm:flex bg-inputbg text-inputText font-medium py-3 px-6 w-full rounded-xl items-center shadow-inner"
                onClick={handleNodeClick}
                type="button">
                {`${nodeValue ? nodeValue.substring(0, 40) : "Select Node"}...`}
                <IoMdArrowDropdown className="ml-1" size="20px" />
              </button>
              <button
                id="mobile"
                className="sm:hidden bg-inputbg text-inputText font-medium py-3 px-6 w-full flex rounded-xl items-center shadow-inner"
                onClick={handleNodeClick}
                type="button">
